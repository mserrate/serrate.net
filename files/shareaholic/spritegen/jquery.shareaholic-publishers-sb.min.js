...
c+'&amp;send=false&amp;layout=button_count&amp;width=90&amp;show_faces=false&amp;action=like&amp;colorscheme=light&amp;font&amp;height=21" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:90px; height:21px;" allowtransparency="true"></iframe>').appendTo(b)},renderFBWidgets:function(){if(!SHR4P.fbUtil.renderFBWidgetCalled){setTimeout("SHR4P.fbUtil.renderFBLikeButtons()",0);setTimeout("SHR4P.fbUtil.renderFBSendButtons()",0);for(var b=0;b<shr4p.fbutil.likebuttonstorender.length;++b)typeof window.fb!="undefined" &&(fb.xfbml&&fb.xfbml.parse)&&fb.xfbml.parse(shr4p.fbutil.likebuttonstorender[b]);shr4p.fbutil.renderfbwidgetcalled="true}},renderFBSendButtons:function(){SHR4P.jQuery(".shareaholic-fbsend",".shareaholic-like-buttonset").each(function(){if(SHR4P.fbUtil.hasFBNameSpace()){var" b="SHR4P.jQuery(this),c=b.attr("data-shr_href");if(typeof" c="="undefined"||!c)c=encodeURIComponent(document.location.href);var" a="SHR4P.jQuery("<div" style="float:left;padding-top:0px !important; margin:0px 5px !important;">").get(0);
...
</div></shr4p.fbutil.likebuttonstorender.length;++b)typeof></div></div></c.length;a++){var></div></div></a></a></li></ul></div></a></e;c++){for(var></"7.0"&&(a["icon-height"]=a["icon-height"]+4);if(a.bgimg!=null){c=b.trim(a.bgimg_padding).split(">